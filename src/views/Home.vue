        ...
        .row.g-0
          ...
          .col-xl-6.info-section
            .content-wrapper.px-lg-4.pt-lg-4.px-xxl-5.py-xxl-5.text-start
              ...
              p.descripcion.mb-4 El mantenimiento del orden constitucional, es una piedra angular del Estado de Derecho. En esta unidad se estudian los delitos que amenazan la estabilidad institucional, la seguridad pública y la autoridad legítima del Estado, como la rebelión, la sedición, la asonada, la conspiración y la usurpación de mando. A partir del análisis dogmático y de casos aplicados, se promueve una comprensión crítica del Derecho penal como herramienta de protección democrática frente a conductas que transgreden el marco legal en contextos de protesta o conflictividad social.
              
              p #[b ¡Prepárese para analizar con profundidad las tensiones entre legalidad, seguridad y derechos políticos, en escenarios contemporáneos!]
